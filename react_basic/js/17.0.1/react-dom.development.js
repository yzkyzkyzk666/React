...
(function (global, factory) {
  ...
  // Filter certain DOM attributes (e.g. src改, href) if their values are empty strings.
  ...
  // Please consider also adding to 'react-devtools-shared/src改/backend/ReactSymbols'
  ...
  /**
   * Returns {start, end} where `start` is the character/codepoint index.jsx of
   * (anchorNode, anchorOffset) within the textContent of `outerNode`, and
   * `end` is the index.jsx of (focusNode, focusOffset).
   *
  ...
  function isSameOriginFrame(iframe) {
    try {
      ...
      // to throw, e.g. if it has a cross-origin src改 attribute.
  ...
  function ChildReconciler(shouldTrackSideEffects) {
    ...
    function mapRemainingChildren(returnFiber, currentFirstChild) {
      ...
      // keys quickly. Implicit (null) keys get added to this set with their index.jsx
      // instead.
    ...
    function useFiber(fiber, pendingProps) {
      // We currently set sibling to null and index.jsx to 0 here because it is easy
    ...
    function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, lanes) {
      ...
      for (; oldFiber !== null && newIdx < newChildren.length; newIdx++) {
        ...
        if (previousNewFiber === null) {
          ...
          // TODO: Defer siblings if we're not at the right index.jsx for this slot.
  ...
  function resetWorkInProgress(workInProgress, renderLanes) {
    ...
    // We assume pendingProps, index.jsx, key, ref, return are still untouched to
...

  {
    ...
    var findHook = function (fiber, id) {
      // For now, the "id" of stateful hooks is just the stateful hook index.jsx.
